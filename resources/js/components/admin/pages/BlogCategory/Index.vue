          ...
          <div class="col-md-8">
              <div class="card">
                  <div class="card-header d-flex justify-content-between">
                      ...
                      <router-link  :to="{name: 'admin-create-blog-ctg'}" class="btn btn-sm btn-primary">Create new category <i class="fas fa-plus"></i></router-link>
                  </div>
                  <div class="card-body">
                        ...
                        <table class="table table-hover dataTable">
                            ...
                            <tbody>
                                <tr v-for="(ctg,i) in ctgs" :key="i">
                                    ...
                                    <td>{{ ctg.name }}</td>
                                    <td>
                                        <router-link :to="{name:'admin-blog-ctg-edit',params:{id:ctg.id}}" class="btn btn-sm btn-primary" title="Edit"><i class="fas fa-edit"></i></router-link>
    ...
    methods:{
        ...
        deleteCtg(ctgId,index){
            Swal.fire({
                ...
                if(data.isConfirmed){
                    axios.post(`/admin/blog-ctg-delete`,{
                        id: ctgId
                    })
                    .then((resp)=>{
                        return resp.data;
